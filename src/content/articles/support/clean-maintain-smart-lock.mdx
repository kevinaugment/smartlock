...
□ If misaligned:
  - Adjust strike plate
  - See: [Lock Jammed Guide](/support/smart-lock-jammed-wont-turn)
```
...
**Troubleshooting:**
- [Lock Jammed] - /support/smart-lock-jammed-wont-turn - Alignment fixes
- [Lock Making Noise] - /support/smart-lock-making-noise - Mechanical issues
