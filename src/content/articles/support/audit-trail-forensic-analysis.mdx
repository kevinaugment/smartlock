...
🔍 **[Log Analyzer](/tools/log-analyzer)** - Query and analyze audit logs  
🚨 **[Anomaly Detector](/tools/anomaly-detector)** - ML-based threat detection  
📅 **[Forensic Timeline Builder](/tools/forensic-timeline-builder)** - Visualize event sequences  
📊 **[Compliance Reporter](/tools/compliance-reporter)** - Automated audit reports
